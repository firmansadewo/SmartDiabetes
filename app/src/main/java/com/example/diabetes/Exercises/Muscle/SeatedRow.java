...
public class SeatedRow extends Fragment {
    Button buttonstart;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_seated_row, container, false);
        ...
        buttonstart.setOnClickListener(new View.OnClickListener() {
            ...
            private void openSeatedRow() {
                SeatedRowstart fragment = SeatedRowstart.newInstance();
