...
public class Plank extends Fragment {
    Button buttonstart;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_plank, container, false);
        ...
        buttonstart.setOnClickListener(new View.OnClickListener() {
            ...
            private void openPlankstart() {
                Plankstart fragment = Plankstart.newInstance();
