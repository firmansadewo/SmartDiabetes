...
public class MountainP extends Fragment {
Button buttonstart;
    public static MountainP newInstance() {
        MountainP fragment = new MountainP();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonstart.setOnClickListener(new View.OnClickListener() {
            ...
            private void openMountainPstart() {
                MountainPstart fragment = MountainPstart.newInstance();
