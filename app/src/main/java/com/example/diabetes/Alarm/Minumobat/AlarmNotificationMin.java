...
public class AlarmNotificationMin extends Activity
{
  ...
  protected void onCreate(Bundle bundle)
  {
    ...
    setContentView(R.layout.notificationminumobat);

    mDateTime = new DateTimemin(this);
  ...
  {
    super.onDestroy();
    Log.i(TAG, "AlarmNotificationMin.onDestroy()");
  ...
  protected void onNewIntent(Intent intent)
  {
    ...
    Log.i(TAG, "AlarmNotificationMin.onNewIntent()");
  ...
  {
    mAlarm = new AlarmMin(this);
    mAlarm.fromIntent(intent);

    Log.i(TAG, "AlarmNotificationMin.start('" + mAlarm.getTitle() + "')");
  ...
  private void stop()
  {
    Log.i(TAG, "AlarmNotificationMin.stop()");
  ...
  @RequiresApi(api = Build.VERSION_CODES.O)
  private void addNotification(AlarmMin alarm)
  {
    ...
    Log.i(TAG, "AlarmNotificationMin.addNotification(" + alarm.getId() + ", '" + alarm.getTitle() + "', '" + mDateTime.formatDetails(alarm) + "')");
  ...
  private class PlayTimerTask extends TimerTask
  {
    ...
    public void run()
    {
      Log.i(TAG, "AlarmNotificationMin.PalyTimerTask.run()");
      addNotification(mAlarm);
      finish();
    }
  }
