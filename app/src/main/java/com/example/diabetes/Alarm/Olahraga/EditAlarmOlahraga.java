...
public class EditAlarmOlahraga extends Activity
{
  ...
  public void onCreate(Bundle bundle)
  {
    ...
    setContentView(R.layout.editalarmolahraga);
  ...
  {
    if (AlarmOl.ONCE == mAlarm.getOccurence())
      showDialog(DATE_DIALOG_ID);
    else if (AlarmOl.WEEKLY == mAlarm.getOccurence())
