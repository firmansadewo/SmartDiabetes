...
public class EditAlarmMinumobat extends Activity
{
  ...
  public void onCreate(Bundle bundle)
  {
    ...
    setContentView(R.layout.editalarmminumobat);
  ...
  {
    if (AlarmMin.ONCE == mAlarm.getOccurence())
      showDialog(DATE_DIALOG_ID);
    else if (AlarmMin.WEEKLY == mAlarm.getOccurence())
