...
public class AlarmMin implements Comparable<AlarmMin>
{
  ...
  public AlarmMin(Context context)
  {
    mContext = context;
    mId = 0;
    mTitle = "";
  ...
  public int compareTo(AlarmMin aThat)
  {
  ...
  {
    intent.putExtra("com.example.diabetes.id", mId);
    intent.putExtra("com.example.diabetes.title", mTitle);
    intent.putExtra("com.example.diabetes.date", mDate);
    intent.putExtra("com.example.diabetes.alarm", mEnabled);
    intent.putExtra("com.example.diabetes.occurence", mOccurence);
    intent.putExtra("com.example.diabetes.days", mDays);
  }

  public void fromIntent(Intent intent)
  {
    mId = intent.getLongExtra("com.example.diabetes.id", 0);
    mTitle = intent.getStringExtra("com.example.diabetes.title");
    mDate = intent.getLongExtra("com.example.diabetes.date", 0);
    mEnabled = intent.getBooleanExtra("com.example.diabetes.alarm", true);
    mOccurence = intent.getIntExtra("com.example.diabetes.occurence", 0);
    mDays = intent.getIntExtra("com.example.diabetes.days", 0);
    update();
  }
